...
# with command line options: Configuration/GenProduction/python/SMP-RunIIFall18wmLHEGS-00138-fragment.py --fileout file:SMP-RunIIFall18wmLHEGS-00138.root --mc --eventcontent NANOAODSIM --datatier NANOAOD --conditions 102X_upgrade2018_realistic_v11 --beamspot Realistic25ns13TeVEarly2018Collision --step LHE,GEN,NANOGEN --nThreads 8 --geometry DB:Extended --era Run2_2018 --python_filename SMP-RunIIFall18wmLHEGS-00138_1_cfg.py --customise Configuration/DataProcessing/Utils.addMonitoring --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=4 -n 2000 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/SMP-RunIIFall18wmLHEGS-00138-fragment.py nevts:2000'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:SMP-RunIIFall18wmLHEGS-00138.root'),
...
process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=4
